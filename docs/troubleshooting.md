...
| `ROLLBACK_INCOMPLETE`       | The source file was rolled back, but other unexpected working-tree changes remain                                                                   | Review `data.changed_paths`, clean the working tree, and retry                                                                          |
...
| `EXECUTION_SCOPE_VIOLATION` | Verification or a side-effect altered files outside the target source file                                                                          | Ensure verification commands are read-only and do not create artifacts                                                                  |
