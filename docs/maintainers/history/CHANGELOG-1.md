# Changelog — archived (v1.x)

Older releases moved out of the main [CHANGELOG.md](../../../CHANGELOG.md) by `scripts/changelog-archive.mjs` (rolling archive). Verbatim, not summarized; the full history is also in git.
