...
> 🌐 The primary documentation is in English. This page is a Japanese entry point only.

code-pact の一次ドキュメントは英語版です。CLI と adapter の日本語出力（`--locale ja-JP`）はサポートしますが、**仕様・契約・運用手順は英語 docs を正**とします。日本語のミラーは保守しません。
...
完全なドキュメント一覧は [docs/](../README.md) を参照してください。
