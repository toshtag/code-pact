...
| [maintainers/operations.md](maintainers/operations.md) | Deeper maintainer topics — planning wizards, Claude model pinning, adapter-upgrade internals, Spec Kit import, release-prep posture. |
