...
| metric | value |
|---|---|
| `pack_size_p50_bytes` | 19275 |
| `pack_size_p90_bytes` | 49555 |
| `pack_size_max_bytes` | 314774 |
| `first_pass_verify_rate_percent` | 100.0 |
| `lifecycle_adherence_rate_percent` | 80.6 |
...
`tasks_total: 144`, `agents_enabled: 1`. The ~19% non-adherence
