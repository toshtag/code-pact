...
| `TASK_REVIEW_CONTRACT_MISSING` (v2.9+, P90)          | warning         | An active task (`planned` or `in_progress`) declares no `review_contract`. Advisory: `affects_exit: false`, including under `--strict`; `done` and `cancelled` tasks are skipped. A missing contract does not yet block `task lock` — the refusal ships with the enforcement stage and its rollout policy, so an existing plan full of pre-contract tasks keeps working across the upgrade. See [Review contracts](review-contract.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
