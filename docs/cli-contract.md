...
| `MEMORY_PRUNE_CONFLICT`                                                   | `memory prune --write`                                                                                                                                                                                                                                                                                                                                                                                                                             | A local loop-memory retention candidate changed before deletion. Exit code 1; JSON includes `data.partial_applied` and `data.deleted_count`. No candidate is deleted for a preflight conflict; if the conflict happens after pruning starts, earlier candidates may already have been deleted                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `MEMORY_PRUNE_FAILED`                                                     | `memory prune --write`                                                                                                                                                                                                                                                                                                                                                                                                                             | Local loop-memory retention could not be applied for an I/O or platform reason after authority validation. Exit code 1; JSON may include `data.system_code`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
candidates were deleted before the conflict. Re-run `memory status` and dry-run
`memory prune` to inspect the current cache state.
