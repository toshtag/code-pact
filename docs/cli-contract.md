...
| `CONTEXT_NOT_FOUND` (P52)                                                 | `context show`                                                                                                                                                                                                                                                                                                                                                                                                                                    | Referenced context artifact is absent from `.code-pact/cache/context/`. Exit code 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `CONTEXT_INVALID` (P52)                                                   | `context show`                                                                                                                                                                                                                                                                                                                                                                                                                                    | Context artifact JSON, schema, section enum, duplicate-section, byte-count, or section-content digest validation failed. Exit code 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `CONTEXT_DIGEST_MISMATCH` (P52)                                           | `context show`                                                                                                                                                                                                                                                                                                                                                                                                                                    | Context artifact bytes no longer match the digest embedded in its reference, or a section's `content_sha256` no longer matches its content. Exit code 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `CONTEXT_PATH_UNSAFE` (P52)                                               | `context show`                                                                                                                                                                                                                                                                                                                                                                                                                                    | Context artifact path resolution was refused by the context-deferral filesystem authority. Exit code 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `CONTEXT_READ_FAILED` (P52)                                               | `context show`                                                                                                                                                                                                                                                                                                                                                                                                                                    | Reading the context artifact failed after authority validation. Exit code 1; JSON may include `data.system_code`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
