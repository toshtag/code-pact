...
- `PHASE_SNAPSHOT_INVALID` (error) — roadmap references a missing phase file whose archive snapshot exists but cannot release it (corrupt / identity-mismatched / non-terminal / task-id-colliding); fail-closed
