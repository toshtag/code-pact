...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `FOCUSED_VERIFICATION_NOT_CONFIGURED`                                    | `verify --stage focused`                                                                                                                                                                                                                                                                                                                                                                                                                         | The project does not define `.code-pact/project.yaml` `verification_policy.focused_command`. Either configure the policy before using focused stage verification, or run the default/full verification path                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `FULL_RETRY_REQUIRES_FOCUSED_PASS`                                       | `verify --stage full`, `task complete` when `verification_policy` is configured                                                                                                                                                                                                                                                                                                                                                                   | A full verification attempt already ran for the current task/digest, and the next full attempt is blocked until a newer focused verification pass is recorded for the same task and workspace digest. Run `code-pact verify --phase <phase> --task <task> --stage focused --json --detail agent` after making the fix, then retry the full lifecycle                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `FULL_VERIFICATION_BUDGET_EXCEEDED`                                      | `verify --stage full`, `task complete` when `verification_policy` is configured                                                                                                                                                                                                                                                                                                                                                                   | The task has reached the configured full verification attempt budget (`verification_policy.max_full_attempts`, default 2). Stop repeating full gates for the same task; fix with focused evidence, split the task, or explicitly change the project policy                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `VERIFICATION_LEDGER_INVALID`                                            | `verify --stage focused`, `verify --stage full`, `task complete` when `verification_policy` is configured                                                                                                                                                                                                                                                                                                                                          | The derived local verification ledger at `.code-pact/cache/verification-runs/ledger.jsonl` is corrupt, malformed, or outside the project authority. Treat it as untrusted cache state, repair/remove it locally, and rerun focused verification before full verification                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `VERIFICATION_STATE_UNAVAILABLE`                                         | `verify --stage focused`, `verify --stage full`, `task complete` when `verification_policy` is configured                                                                                                                                                                                                                                                                                                                                          | Code Pact could not establish the exact Git verification state for the current HEAD and working tree. This is fail-closed: focused results are not recorded and full authorization is refused. Fix the Git state or unsupported untracked entry, then rerun focused verification                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `INVALID_EVIDENCE_REF`                                                   | `evidence show`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Evidence reference does not match `evidence:sha256:<64 lowercase hex>`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `EVIDENCE_NOT_FOUND`                                                     | `evidence show`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Referenced evidence artifact is absent from `.code-pact/cache/evidence/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `EVIDENCE_INVALID`                                                       | `evidence show`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Referenced evidence artifact is not valid JSON or does not match the evidence artifact schema; fail-closed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `EVIDENCE_DIGEST_MISMATCH`                                               | `evidence show`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Evidence file content no longer matches the digest embedded in its reference; fail-closed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `EVIDENCE_PATH_UNSAFE`                                                   | `evidence show`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Evidence cache path resolution encountered a traversal, symlink, or filesystem authority boundary; fail-closed. JSON envelopes may include `data.system_code` for diagnostics                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `EVIDENCE_READ_FAILED`                                                   | `evidence show`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Evidence cache read failed for an I/O or platform-specific reason; fail-closed. JSON envelopes may include `data.system_code` for diagnostics                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `EVIDENCE_UNAVAILABLE`                                                   | Nested `data.failure.evidence_error.code` on `verify --detail agent`, `task complete --detail agent`                                                                                                                                                                                                                                                                                                                                              | Verification failed and the derived evidence cache could not be written; the top-level error remains `VERIFICATION_FAILED`. `data.failure.evidence_error.cause_code` carries the stable reason, and `system_code` may carry a diagnostic platform errno                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `EVIDENCE_CONFLICT`                                                      | Nested `data.failure.evidence_error.cause_code` on `verify --detail agent`, `task complete --detail agent`                                                                                                                                                                                                                                                                                                                                        | Content-addressed evidence path already exists with bytes that do not match the canonical artifact for the same digest; the evidence cache is unavailable but the verification failure remains the top-level error                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `VERIFICATION_FAILED`                                                    | `verify`, `task complete`                                                                                                                                                                                                                                                                                                                                                                                                                         | Deterministic completion check did not pass. The envelope may also carry `error.cause_code`: `task complete` uses `DECISION_REQUIRED`, `COMMANDS_FAILED`, or `ABORTED`; standalone `verify` uses `ABORTED` for cancellation (see [Public cause codes](#public-cause-codes)). In default/full JSON, standalone `verify` preserves the detailed message and `data.checks`; in `--detail agent`, `error.message` is a short fixed string and actionable details live under `data.failure.kind`, `data.failure.check`, `data.failure.reason`, and optional command-output fields. `error.code` stays `VERIFICATION_FAILED` at exit 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `TASK_DEPENDENCY_INCOMPLETE`                                             | `task start`, `task complete`, `task record-done`                                                                                                                                                                                                                                                                                                                                                                                                 | A task's `depends_on` task is not `done`. Exit 2. `data.deps` lists the incomplete dependency ids. No contract lock or progress event is recorded for `task start`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `CONTEXT_OVER_BUDGET` (v1.13+ / P24)                                     | `task context --budget-bytes`, `task prepare --budget-bytes`                                                                                                                                                                                                                                                                                                                                                                                      | Even maximal section deferral could not bring the rendered pack at or below the requested byte budget. Exit code 2. The envelope carries `data.budget_bytes`, `data.minimum_achievable_bytes` (the post-maximal-deferral size, including the Deferred Context section when deferral applies — re-running with this value as the budget succeeds), and `data.unelidable_sections` (the structural floor)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `INVALID_CONTEXT_REF` (P52)                                              | `context show`                                                                                                                                                                                                                                                                                                                                                                                                                                    | Context reference does not match `context:sha256:<64 lowercase hex>`. Exit code 2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `CONTEXT_NOT_FOUND` (P52)                                                | `context show`, `task prepare` readback verification                                                                                                                                                                                                                                                                                                                                                                                              | Referenced context artifact is absent from `.code-pact/cache/context/`. Exit code 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `CONTEXT_INVALID` (P52)                                                  | `context show`, `task prepare` deferred artifact validation                                                                                                                                                                                                                                                                                                                                                                                       | Context artifact JSON, schema, section enum, duplicate-section, byte-count, or section-content digest validation failed; or a context pack carries inconsistent deferred metadata. Exit code 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `CONTEXT_DIGEST_MISMATCH` (P52)                                          | `context show`, `task prepare` deferred artifact validation                                                                                                                                                                                                                                                                                                                                                                                       | Context artifact bytes no longer match the digest embedded in its reference, or a section's `content_sha256` no longer matches its content. Exit code 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `CONTEXT_PATH_UNSAFE` (P52)                                              | `context show`, `task prepare` deferred artifact materialization                                                                                                                                                                                                                                                                                                                                                                                  | Context artifact path resolution was refused by the context-deferral filesystem authority. Exit code 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `CONTEXT_READ_FAILED` (P52)                                              | `context show`, `task prepare` readback verification                                                                                                                                                                                                                                                                                                                                                                                              | Reading the context artifact failed after authority validation. Exit code 1; JSON may include `data.system_code` from the underlying platform cause                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `CONTEXT_WRITE_FAILED` (P52)                                             | `task prepare` deferred artifact materialization                                                                                                                                                                                                                                                                                                                                                                                                  | Writing the content-addressed context manifest failed for an I/O or platform reason after authority validation. Exit code 1; JSON may include `data.system_code` from the underlying platform cause                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `MEMORY_PATH_UNSAFE`                                                     | `memory status`, `memory prune`                                                                                                                                                                                                                                                                                                                                                                                                                   | Local loop-memory cache path resolution crossed a symlink or filesystem authority boundary. Exit code 1; JSON may include `data.system_code`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `MEMORY_READ_FAILED`                                                     | `memory status`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Local loop-memory cache status could not be read after authority validation. Exit code 1; JSON may include `data.system_code`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `MEMORY_PRUNE_CONFLICT`                                                  | `memory prune --write`                                                                                                                                                                                                                                                                                                                                                                                                                            | A local loop-memory retention candidate changed before deletion. Exit code 1; JSON includes `data.partial_applied` and `data.deleted_count`. No candidate is deleted for a preflight conflict; if the conflict happens after pruning starts, `deleted_count` counts only successful unlinks by this invocation; a candidate that another process already removed is skipped and not counted                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `MEMORY_PRUNE_FAILED`                                                    | `memory prune --write`                                                                                                                                                                                                                                                                                                                                                                                                                            | Local loop-memory retention could not be applied for an I/O or platform reason after authority validation. Exit code 1; JSON may include `data.system_code`; when deletion had begun it may also include `data.partial_applied` and `data.deleted_count`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `OWNED_TEXT_TOO_LARGE`                                                   | (internal — never a top-level `error.code`)                                                                                                                                                                                                                                                                                                                                                                                                       | Bounded-read guard: `readOwnedTextBounded` tags an owned file that exceeds the caller's byte budget. Loop-memory callers catch and remap it to corrupt-file diagnostics or prune-conflict failures before it reaches an agent. Listed here only so the error-code surface stays complete                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `EDIT_REJECTED` | `task execute` | The executor returned a `replace_exact` payload that could not be applied to the source file (stale SHA, path not in `writes`, empty old_text, multiple matches, no-op replacement, UTF-8 invalid, resulting source exceeds `MAX_SOURCE_BYTES` (`8192` bytes, reason `RESULTING_SOURCE_TOO_LARGE`), or SHA mismatch). Exit code 1. The envelope carries `data.reason` (bounded to 2,048 UTF-8 bytes). |
...
| `EXECUTOR_FAILED` | `task execute` | The external executor exited non-zero, timed out, emitted malformed or oversized JSON, or returned an unsupported `kind`/unknown keys. Exit code 1. The envelope carries `data.reason` (bounded to 2,048 UTF-8 bytes). |
...
| `LOCAL_MEMORY_PRUNE_SKIPPED` | `task complete` success or verification-failure JSON only when local loop-memory retention failed after recording | The task completion source of truth is unchanged and the local episode was recorded, but best-effort retention maintenance did not complete. The warning has `affects_exit: false`; run `memory prune` later if the local advisory cache matters. |
...
| `TASK_REGRESSION_EVIDENCE_MISSING` (P57)                                     | warning          | `plan lint --include-quality`                                                                                                                                                                                                                      | An active task (`planned` or `in_progress`) with `type: bugfix` declares no static regression evidence. Evidence is limited to a new test, fixture, or reproduction artifact in `writes`, or an existing test, fixture, or reproduction artifact in `acceptance_refs`. `writes` paths are not existence-checked; `acceptance_refs` paths must resolve to an existing regular file inside the project and must not escape through unsafe paths or project-outside symlinks. Accepted path forms are the closed classifier `**/*.test.*`, `**/*.spec.*`, `**/*_test.*`, `**/test_*.*`, and files under `tests/`, `test/`, `__tests__/`, `spec/`, `specs/`, `fixtures/`, or `reproductions/` at any level; the directory marker alone (`tests`, `src/tests`, `fixtures`, etc.) is not evidence. Advisory: `affects_exit: false`, including under `--strict`; `done` and `cancelled` tasks are skipped. The check is declaration-only and does not read or score test quality                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `TASK_REVIEW_CONTRACT_MISSING` (v2.9+, P90)          | warning         | An active task (`planned` or `in_progress`) declares no `review_contract`. Advisory: `affects_exit: false`, including under `--strict`; `done` and `cancelled` tasks are skipped. Whether a missing contract blocks `task lock` depends on the project's `review_contract_policy`: absent or `advisory` keeps this a plan-lint advisory only, while `required` turns it into the top-level `TASK_REVIEW_CONTRACT_REQUIRED` refusal. Absence reads as `advisory`, so an existing plan full of pre-contract tasks keeps working across the upgrade. See [Review contracts](review-contract.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `TASK_REVIEW_CONTRACT_INVALID` (v2.9+, P90)          | error           | A declared `review_contract` parsed but contradicts the task that owns it — `minimal` mode on work that is not low-risk docs / mechanical_refactor, a missing or duplicated boundary stage or platform, an `in_scope` stage or `required` platform with no claim / rationale / refs, an `os` stage in scope with no `actual_platform` requirement, duplicate or unbacked evidence, or a ref outside the task's declared scope. `details.reason` carries the machine-readable cause. Dual-surface: also a top-level code (exit 2) from `task add`, `task lock`, and `task start`. One validator backs every surface, so plan lint can never accept a contract those commands refuse. See [Review contracts](review-contract.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
- `TASK_REGRESSION_EVIDENCE_MISSING` (P57, advisory, `affects_exit: false`) — an active `type: bugfix` task declares no static regression evidence in `writes` or `acceptance_refs`
...
**Regression evidence advisory (P57).** `TASK_REGRESSION_EVIDENCE_MISSING`
appears only under `--include-quality`. It applies only to `type: bugfix` tasks
whose design status is `planned` or `in_progress`; `done` and `cancelled` tasks
are historical and skipped. The accepted sources are `writes` for new
regression artifacts and `acceptance_refs` for existing artifacts. Accepted
forms are the closed path classifier `**/*.test.*`, `**/*.spec.*`,
`**/*_test.*`, `**/test_*.*`, plus files under `tests/`, `test/`,
`__tests__/`, `spec/`, `specs/`, `fixtures/`, or `reproductions/` at any level.
The directory marker alone is not evidence: `tests`, `src/tests`, `fixtures`,
and `src/reproductions` still fire the advisory, while `tests/session.test.ts`,
`tests/regression-case`, and `tests/**` qualify in `writes`. `writes`
declarations are not existence-checked. `acceptance_refs` must name a present
project-contained regular file; existing directories, URL strings, commands,
missing paths, unsafe paths, project-outside symlinks, manual tests,
screenshots, logs, comments, PR descriptions, verification commands, and
Failure Capsule output are not static regression evidence. The advisory is
declaration-only: it does not read test content and does not prove that a test
prevents a runtime failure.
...
```json
{
  ...
  "severity": "warning",
  "affects_exit": false,
  "message": "Task \"P57-TX\" is a bugfix but declares no static regression evidence. Add a new test, fixture, or reproduction artifact to writes, or reference an existing one from acceptance_refs.",
  "file": "design/phases/P57-example.yaml",
  "phase_id": "P57",
  "task_id": "P57-TX",
  "details": {
  ...
  "recovery": {
    "manual_action": "Add a new test, fixture, or reproduction path to writes, or add an existing artifact path to acceptance_refs.",
    "confirm": "code-pact plan lint --include-quality --json",
    "reference": "docs/concepts/task-readiness-fields.md#regression-evidence-for-bugfix-tasks"
  }
}
```

The issue has no `path` field because the problem spans both `writes` and
`acceptance_refs`. At most one issue is emitted per task, and `--strict` does
not make this advisory exit-relevant.
...
**`--strict` semantics (binary promotion).** When `--strict` is passed, **exit-relevant** warnings — regardless of code — become failures. Issues marked `affects_exit: false` (the P31 clarify/readiness advisories above, mirroring `plan analyze`'s `done-historical`) stay advisory even under `--strict`: they are visible in output and counted under `advisories`, but never change the exit code. Among exit-relevant warnings this includes P10's `TASK_WRITES_PROTECTED_PATH`: a planned task that declares `writes: design/roadmap.yaml` is informational under default lint and exit-relevant under `--strict`. Once that task is `status: done`, the same protected-write warning is historical and no longer exit-relevant. Selective per-code promotion ("promote only `TASK_WRITES_PROTECTED_PATH`, leave other warnings advisory") is **not** supported in v1.5+; it remains a P15+ candidate. Choose `--strict` when you want a fail-fast posture on any exit-relevant advisory; omit it when the project legitimately declares advisories you want to keep as warnings.
...
```jsonc
{
  ...
  "deferred_bytes": 38112, // sum of original deferred section bytes
...
With **no** budget, `natural_bytes === final_bytes`, `saved_bytes === 0`,
`deferred_bytes === 0`, `saved_ratio === 0`, `elided_sections === []`, and
`budget_bytes` is omitted. The metrics make the existing P24/P47 budget
behavior observable; they introduce **no semantic reduction policy** — only an
explicit `--budget-bytes` / `--context-budget` invocation can defer sections,
and the no-flag pack stays byte-identical. The metrics surface only on
`--explain --json` (not on normal `task context` output, and not on `task
prepare`).
...
`code-pact task context <task-id> [--agent <name>] [--json] [--explain] --budget-bytes <N>` enforces a deterministic upper bound on the rendered pack size by progressively deferring sections in a fixed priority order until the rendered UTF-8 byte length falls at or below `N`. When even maximal deferral cannot meet the bound, the command fails with the public error code `CONTEXT_OVER_BUDGET`.
...
**Deferral priority (locked).** Sections are withheld in this order until the budget is met:
...
`sections[].name` is a closed enum of context section names, duplicates are
invalid, `bytes` must equal `Buffer.byteLength(content, "utf8")`, and
`content_sha256` is computed from the exact UTF-8 section content. The manifest
...
Sections excluded by the v1.11 inclusion policy (e.g. `not_declared_by_task` for P10 fields the task did not declare) keep their v1.11 reason codes; budget deferral applies only to sections that would otherwise have been included.

**`CONTEXT_OVER_BUDGET` envelope.** When maximal deferral still exceeds the budget:
...
**P75 update:** default output is now a stable Minimum Sufficient Work Order
(`--detail minimal`); the previous detailed contract is available with
`--detail full` or any explicit budget flag.

`code-pact task prepare <task-id> [--agent <name>] [--json] [--detail minimal|full] [--dry-run]` is a **progress-read-only** compound command. By default (`--detail minimal`) it returns a stable **Minimum Sufficient Work Order**: the task's goal, declared read/write scope, done criteria, verification commands, decision status, a single `next` action, a `more` command to fetch the full envelope, and honest (but minimal) failure info for `failed` states. It does **not** build or write a context pack, resolve a recommendation, read decision bodies, or scan memory.

Use `--detail full` (or any explicit budget flag: `--budget-bytes`, `--context-budget`, `--recommended-context-budget`) to also receive the historical detailed contract: `recommendation`, context-pack metadata, the full `commands` dictionary, and `decision_commitments` for gated tasks.

The command MUST NOT record a progress event (the ledger is left unchanged) on any code path. It writes the deterministic context pack at `<agent-profile>.context_dir/<task-id>.md` only in `--detail full` (or when a budget is applied); `--dry-run` is honored there and returns `would_write_context_pack_path`.

### Flags

The flag list, value types, and examples live in the generated [CLI reference § `task prepare`](cli-reference.generated.md). Contract notes on specific flags: `--agent` shares `task context`'s validation (`AGENT_NOT_FOUND` / `AGENT_NOT_ENABLED`); `--detail` chooses `minimal` (default) or `full` output; `--dry-run` returns `would_write_context_pack_path` instead of `context_pack_path` and is only meaningful in `--detail full` (or with an explicit budget); `--budget-bytes <N>` (v1.13+, P24) elides sections in the priority order defined in [`task context --budget-bytes`](#--budget-bytes-n-v113-p24) and throws `CONTEXT_OVER_BUDGET` (exit 2) when unachievable, with no progress event recorded on the failure path (the progress-read-only invariant from P21-T3); `--context-budget <profile>` (v1.30+, P47) is the ergonomic alias for `--budget-bytes`, resolving a named profile to bytes before that same path (see [`task context --context-budget`](#--context-budget-profile-v130-p47)); `--recommended-context-budget` applies the deterministic `recommendation.contextFit` profile and bytes produced in the same call. The three budget flags are mutually exclusive. Any explicit budget flag implies `--detail full` for the pack-build path.
...
Default output (`--detail minimal`) is a stable **Minimum Sufficient Work Order**;
`--detail full` preserves the previous detailed contract. The schema below shows
both forms; `null` means the field is present and explicitly set to `null`.
...
```json
{
  ...
  "data": {
    ...
    "task": {
      ...
      "decision_refs": [] // present only when decision_required is true
    },
    "next": {
      "type": "start_task",
      "command": "code-pact task start P21-T4 --agent claude-code"
    },
    "more": {
      "command": "code-pact task prepare P21-T4 --agent claude-code --detail full --json"
    },
    "blocked_by": [],
    "failure": {
...
In `--detail full` (or when an explicit budget flag is supplied) the previous
historical contract is returned, with `detail: "full"` added for stable
discrimination:
...
```json
{
  ...
  "data": {
    ...
    "applied_context_budget": { "source": "none" },
    "context_pack_path": ".../<task-id>.md",
    "context_pack_bytes": 18422,
    "deferred_context": {
      /* P52 deferred context metadata */
    },
    ...
    "commands": {
      ...
      "verify": "code-pact verify --phase <phase> --task <task-id> --json --detail agent",
      "complete": "code-pact task complete <task-id> --agent <agent> --json --detail agent",
...
- In `--detail minimal`, `runTaskPrepare` does **not** build or write a context
...
- `already_done` is present (always `true`) only when `task.state === "done"`.
- `applied_context_budget` is present on the context-pack build path, including
  ...
  `recommended_cli`, and `recommended_agent_profile`.
- `deferred_context` (P52) is present only when an explicit budget caused at
  least one section to be withheld.
- `commands` is the complete mode-agnostic lookup table; all keys are present
  in every lifecycle mode. `commands.verify` and `commands.complete` include
  `--json --detail agent` so verification failures arrive as compact capsules.
  The `record-done` entry is a template (not runnable verbatim).
- `decision_commitments` (P43) is present (possibly `[]`) **only for a
  `requires_decision` task** in `--detail full`; it is omitted entirely for
  non-gated tasks.
...
explicit fallback to retrieve the full envelope.

`recommendation` is present in `--detail full` (and in the minimal-mode
`failure` case it is absent). In full mode it is `null` only in the
early-return states `wait_for_dependencies` and `noop_already_done` — i.e.
`done`, `blocked`, or an unmet `depends_on`. In every workable state (`planned`,
`started`, `resumed`, `failed`) it is a populated `RecommendResult` whose `tier`
/ `effort` / `modelId` / `lifecycleMode` / `repairPolicy` an agent can trust.
A `null` here means "nothing to recommend yet", never "recommendation unavailable".
...
| 1    | Deferred context artifact validation/materialization failed: `CONTEXT_INVALID`, `CONTEXT_DIGEST_MISMATCH`, `CONTEXT_PATH_UNSAFE`, `CONTEXT_READ_FAILED`, or `CONTEXT_WRITE_FAILED`. |
| 2    | `CONFIG_ERROR` (bad flag), `TASK_NOT_FOUND`, `AMBIGUOUS_TASK_ID`, `AMBIGUOUS_PHASE_ID`, `AGENT_NOT_FOUND`, `AGENT_NOT_ENABLED`, or `CONTEXT_OVER_BUDGET`.                           |

Deferred artifact failures are operational failures, not configuration errors. They are surfaced as context-specific public codes and never as `INTERNAL_ERROR`; true unrecognized programming defects still propagate to exit 3.
...
| `LOOP_MEMORY_CACHE_NOT_GITIGNORED`              | warning  | `/.code-pact/cache/` is not ignored. Local loop-memory episodes must stay machine-local; add `/.code-pact/cache/` to `.gitignore`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `LOOP_MEMORY_TRACKED`                           | warning  | One or more files under `.code-pact/cache/loop-memory/` are tracked by git. Remove them from version control and keep the cache ignored. Doctor reports only; it never runs `git rm`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `LOOP_MEMORY_PATH_UNSAFE`                       | warning  | The local loop-memory cache path resolves through a symlink or outside the project. Memory reads/writes fail closed; replace it with a normal directory under `.code-pact/cache/loop-memory/`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
`code-pact task add <phase-id> [flags]` appends a task to the named phase's `tasks[]` array. Three paths share the same write contract:
...
- **Review contract (v2.9+, P90)** — `--review-contract-file <path>` reads a `review_contract` fragment (YAML or JSON — the file holds the contract itself, not a whole task spec) and attaches it to the created task. Mutually exclusive with `--spec-file`, which carries its own contract; combining them is a `CONFIG_ERROR`. A file that is missing, outside the project, or not parseable is a `CONFIG_ERROR`; a fragment with the wrong shape or an unknown key, or one whose semantics do not hold for the finished task, is `TASK_REVIEW_CONTRACT_INVALID` (exit 2) with `data.issues[]` and no phase YAML write. See [Review contracts](review-contract.md).
...
The presence of `--description` or `--spec-file` is the mode switch. Four branches:

| Input                                                                                                  | Behaviour                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--spec-file` provided                                                                                 | Spec-file path. Mutually exclusive with all task-field flags and `--id`; `phase_id` in the spec must match the positional `<phase-id>`.                   |
...
The spec-file path additionally includes `registrationMode: "spec_file"`, `specDigest`, `storedTaskDigest`, and `roundTripEqual: true`.
...
`code-pact verify --phase <phase-id> --task <task-id> [--timeout <ms>] [--dry-run] [--json] [--detail full|agent]` runs deterministic completion checks without recording progress.
...
Each executed command is preserved under the `commands` check as an ordered `commands[]` entry with stable fields: `command`, `ok`, `exitCode`, `timedOut`, `aborted`, `elapsedMs`, `stdout`, `stderr`, and, when termination was attempted, `termination`. Output remains bounded by raw bytes; valid UTF-8 split across stream chunks is decoded continuously, and truncation is marked in the captured stream without flushing a partial multibyte sequence as replacement characters. A timeout is reported as `VERIFICATION_FAILED` with a timed-out command result. Cancellation is reported as `VERIFICATION_FAILED` with `error.cause_code: "ABORTED"`.

`--detail` is valid only with `--json`. Omitted or `full` preserves the existing JSON shape; internal capture metadata such as stdout/stderr truncation flags is not emitted there. `--detail agent` returns a compact projection and bounds the final serialized CLI JSON line below 24 KiB across success, verification failure, cancellation, and preflight/configuration errors. On failure, `error.message` is a short fixed string; bounded details live under `data.failure`. If the outer envelope must omit fields to stay within the bound, `data.projection_truncated: true` and `data.omitted_fields[]` identify what was omitted; executable suggestions are omitted rather than truncated. `data.failure` contains a schema-versioned failure capsule with `kind` and command metadata when available. `fingerprint`, UTF-8-safe stdout/stderr excerpts, `evidence_ref`, and `retrieve_command` are present only for command-output failures that have captured output to fingerprint and persist. `decision_required`, preflight/configuration failures, and `invalid_state` failures do not create Evidence artifacts; preflight/configuration failures use `check: "preflight"` and do not create empty evidence files. `data.verify` contains check summaries and successful command metadata only. Raw stdout/stderr are not duplicated in `checks[]` or `commands[]` in this mode. For command-output failures, the bounded captured stdout/stderr are stored under `.code-pact/cache/evidence/<sha256>.json`; the reference format is `evidence:sha256:<64 lowercase hex>`. If the evidence cache write fails, the top-level error remains `VERIFICATION_FAILED`; `data.failure.evidence_available` is `false`, and `data.failure.evidence_error` carries `code: "EVIDENCE_UNAVAILABLE"`, a stable `cause_code`, and an optional diagnostic `system_code`.
...
Context references use `context:sha256:<64 lowercase hex>` and resolve under `.code-pact/cache/context/`. Invalid references are `INVALID_CONTEXT_REF` at exit 2. Missing artifacts, corrupt manifests, digest mismatches, traversal attempts, and symlink/authority failures are fail-closed at exit 1 with the `CONTEXT_*` public codes listed in [Public codes](#public-codes-top-level-error-envelopes). JSON envelopes for platform read failures may include `data.system_code` from the underlying cause as a diagnostic; the top-level context code itself is not repeated as `system_code`.
...
regular-file entries whose bytes were safely measured after bounded reads,
including invalid UTF-8 files; it is not total cache disk usage.
`corrupt_unmeasured_count` reports corrupt entries whose bytes were not measured,
such as invalid filenames, read failures, symlinks, and directories. Human
output labels the same accounting as `Corrupt entries`, `Measured corrupt
bytes`, and `Unmeasured corrupt entries`.
...
task design status. If a candidate changes during preflight, the command fails
with `MEMORY_PRUNE_CONFLICT` before deleting anything. If a candidate changes
after pruning has started, the same code is returned with
`data.partial_applied: true` and `data.deleted_count` reporting how many
retention files this invocation successfully unlinked before the conflict. A
candidate that disappears after the final identity read but before unlink is an
idempotent skip, not a counted delete. If an I/O or platform failure interrupts
deletion, `MEMORY_PRUNE_FAILED` may carry the same partial metadata plus
`data.system_code`. The final identity-read to unlink window is not a portable
filesystem compare-and-swap; re-run `memory status` and dry-run `memory prune`
to inspect the current cache state.
...
With `--json --detail agent`, `task complete` preserves `error.code` and `error.cause_code`, but uses a fixed short `error.message` and replaces the full failure detail under `data` with the same compact `failure` + `verify` projection documented for standalone `verify`. The final serialized CLI JSON line is bounded below 24 KiB. No progress event is recorded on this failure path. Non-dry-run failure handling may write a best-effort local loop-memory episode, and command-output failures may write the derived evidence cache. If evidence writing fails, the verification failure remains top-level and the evidence problem is nested under `data.failure.evidence_error`; if loop-memory recording fails, the verification failure remains top-level and the memory problem is reported only as a non-fatal warning.

When a retained prior failure has the same exact command-output fingerprint, `task complete --json --detail agent` may add `data.prior_local_signal` with `schema_version`, `exact_match_count`, and `last_observed_at`; the object is advisory, canonical JSON <= 1 KiB, omitted on first observation, and never added to default/full JSON. The signal only means that the same fingerprint exists in bounded local history; it does not describe previous repair attempts or hypotheses, so agents must not infer them from the signal. If the current conversation or diff proves the same change is being rerun unchanged, avoid that rerun. If `stopOnRepeatedFingerprint` is true, the stop contract takes precedence.
...
4. **Contract-lock drift gate**. Requires a contract lock for the task (created by `task start` or `code-pact task lock`). If the lock is missing, exits 2 with `TASK_CONTRACT_LOCK_REQUIRED`. If the locked contract no longer matches the current task declaration or base ref, exits 1 with `TASK_CONTRACT_DRIFT` and supplies `data.locked_digest`, `data.current_digest`, `data.changed_fields`, and `data.drift[]`.
5. **Idempotency check.** If the phase YAML already has `status: done` for this task, returns `kind: "already_finalized"` (exit 0) with no write attempt.
6. **Dry-run or `--write`.** In dry-run, returns `kind: "would_finalize"` with `planned_writes[]`. In `--write`, calls `atomicWriteText` to apply the change and returns `kind: "finalized"` with `applied_writes[]`.
...
| `lifecycle_control_plane` | `{ file: string; changed_fields: string[] }[]`        | Phase files whose only changes are lifecycle-only status mutations (`task finalize`, `phase reconcile`, manual closeout). These are removed from `outside_declared` and recorded transparently; non-lifecycle phase mutations remain `TASK_CONTRACT_DRIFT` (v2.7+, P81-T1) |
...
| `TASK_CONTRACT_DRIFT`                        | **1** | The task contract has drifted from its lock. `data.locked_digest`, `data.current_digest`, `data.changed_fields`, and `data.drift[]` are supplied.                                                                         |
| `TASK_CONTRACT_LOCK_REQUIRED`                | 2     | No contract lock exists for the task. Run `code-pact task lock <id>` or `code-pact task start <id>` first.                                                                                                                |
...
## `task lock` — create a versioned task contract lock (v2.7+, P79-T4)
...
**Review contract (v2.9+, P90).** When the task declares a `review_contract`, it is validated before any git work and before the lock file is written; one that contradicts its task is refused with `TASK_REVIEW_CONTRACT_INVALID` (exit 2, `data.issues[]` carries each `details.reason`) and no lock file is written. The contract is stored in `contract.review_contract` and in the registration digest, so any post-lock edit to a stage, platform, claim, evidence entry, or ref surfaces as `TASK_CONTRACT_DRIFT` with `review_contract` in `changed_fields`.

Whether a task that declares **no** contract may be locked is decided by `.code-pact/project.yaml` `review_contract_policy` (`advisory` | `required`). An **absent** field reads as `advisory`, so upgrading never makes an existing plan unlockable, and `plan lint` surfaces the gap as the `TASK_REVIEW_CONTRACT_MISSING` advisory. Under `required` the lock is refused with `TASK_REVIEW_CONTRACT_REQUIRED` (exit 2, `data` carries `task_id` and `review_contract_policy`) and **no lock file and no progress event** are written — the same refusal reaches the `task start` auto-lock, which shares this single check. A value outside the enum is a project schema error, so `validate` / `doctor` report it and the lock path fails with `CONFIG_ERROR` rather than silently reverting to `advisory`. `init` writes `review_contract_policy: required` into new projects. The refusal applies to **new** locks only: existing lock files, archived phases, and done tasks are never rewritten or retro-validated, and locks and tasks written before the field existed have no `review_contract` on either side and stay readable and drift-free. See [Review contracts](review-contract.md).
...
| `TASK_REVIEW_CONTRACT_INVALID`    | 2    | The task's `review_contract` contradicts the task. `data.issues[]` lists each failing rule with a machine-readable `details.reason`. No lock is written                                                              |
| `TASK_REVIEW_CONTRACT_REQUIRED`   | 2    | The project sets `review_contract_policy: required` and the task declares no `review_contract`. `data` carries `task_id` and `review_contract_policy`. No lock is written                                            |
...
`code-pact task ci-parity <task-id> [--json]` re-runs classifier-selected verification commands locally and checks that the cached review manifest still matches the current `HEAD` and tree. It is intended as a local parity check before trusting remote CI. It requires a review manifest created by `task review-bundle`.

If the manifest is missing, exits 2 with `CI_PARITY_MANIFEST_MISSING`. If `HEAD` or the tree has drifted since the manifest was written, exits 1 with `CI_PARITY_HEAD_MISMATCH`. If any local verification command fails, exits 1 with `VERIFICATION_FAILED`.
...
| `TASK_NOT_FOUND`             | 2    | Task id is not present in any phase                                    |
| `AMBIGUOUS_TASK_ID`          | 2    | Task id appears in more than one phase                                 |
| `CI_PARITY_MANIFEST_MISSING` | 2    | No review manifest exists for the task; run `task review-bundle` first |
| `CI_PARITY_HEAD_MISMATCH`    | 1    | `HEAD` or the tree SHA no longer matches the manifest                  |
| `VERIFICATION_FAILED`        | 1    | A classifier-selected local verification command failed                |
| `CONFIG_ERROR`               | 2    | Missing positional task id or unknown flag                             |
...
**Review contract gate (v2.9+, P90):** The auto-lock above goes through the same check `task lock` does, so a supplied contract that contradicts its task exits 2 with `TASK_REVIEW_CONTRACT_INVALID`, and — when the project sets `review_contract_policy: required` — a task with no contract exits 2 with `TASK_REVIEW_CONTRACT_REQUIRED` (`data.task_id`, `data.review_contract_policy`). Either refusal happens before the lock is written, so **no lock file and no `started` event** are created. See [Review contracts](review-contract.md).
...
Since v1.11, `task prepare` is the primary per-task entry point for the agent-facing loop. Full-detail `task prepare` (or any explicit budget flag) embeds this recommendation in its response; default minimal `task prepare` does not include it. Call `recommend` directly when you need to inspect the deterministic recommendation in isolation, debug recommendation inputs, or support an older/manual loop — then use its output to decide what to load, how hard to think, and what to verify before implementation. It is read-only and does not fetch or write the context pack.
...
| `.code-pact/cache/evidence/*.json`                                                                                | `verify --json --detail agent`, `task complete --json --detail agent` on command-output failure                                                                                  | Derived, content-addressed cache of bounded verification stdout/stderr. Ignored by default; retrieve via `code-pact evidence show <ref>`.                                                                                                                                                                                                                                                           |
| `.code-pact/cache/context/*.json`                                                                                 | `task prepare --detail full` (or any explicit budget flag) with a context budget that defers one or more sections                                                                | Derived, content-addressed cache of exact deferred context sections. Ignored by default; retrieve via `code-pact context show <ref>`. Full-detail `task prepare` writes and readback-verifies the manifest before atomically writing the context pack. `task context`, `task prepare --dry-run`, and `buildContextPack()` do not create this directory or write artifacts.                          |
| `.code-pact/cache/loop-memory/v1/episodes/*.json`                                                                 | `task complete` best-effort episode recording; `memory prune --write` deletes retention candidates                                                                               | Derived, machine-local cache of bounded verification episodes. Ignored by default. `memory status` reports aggregates only; `memory prune` is dry-run unless `--write` is present.                                                                                                                                                                                                                  |
...
| `<agent-profile>.context_dir/<task-id>.md` (context pack; default `.context/<agent>/<task-id>.md`)                | `task prepare --detail full` (or any explicit budget flag; unless `--dry-run`), `pack`                                                                                           | One write per full-detail `task prepare` / `pack` invocation. `task context` does **not** write — it builds and returns/prints the same bytes. The file is regenerable; the default context dir is gitignored (`/.context/`), and a custom `context_dir` should likewise be treated as ignorable agent output. Not tracked in the adapter manifest                                                  |
...
If a context manifest write or readback verification fails, `task prepare` does
not write or replace the context pack. If manifest materialization succeeds and
the later pack write fails, the content-addressed manifest may remain orphaned;
this is acceptable derived state and is not rolled back. Re-saving the same
manifest bytes is idempotent. A same-digest path with different bytes is a
digest conflict and fails closed.
...
corrupt, invalid-UTF-8, nonregular, or filename/content identity-mismatched
files are not normal episodes and are not retention candidates. `memory status`
reports those corrupt episode entries; `doctor` reports cache ignore, tracking,
placement, and path-safety problems, not individual corrupt episode files. P58
records episodes only; `task prepare`, `task context`, and `recommend` do not
read loop memory or inject it into context.
...
| `task prepare` / `task finalize` / `task runbook` / `phase reconcile` / `phase runbook`                                               | `task prepare` is the recommended per-task entry point; full-detail `task prepare` (or any explicit budget flag) bundles `task context` |
| `memory status` / `memory prune`                                                                                                      | Local derived cache maintenance; `memory prune` is dry-run unless `--write` is present                                                  |
