...
- The publish job runs `pnpm release:check`, builds and inspects the exact tarball, publishes that tarball, then downloads it from the registry and verifies its bytes against registry shasum/integrity.
