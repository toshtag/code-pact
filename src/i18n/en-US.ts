    ...
    adapterCommon: {
      ...
      agentContract: {
        ...
        whenBody: [
          ...
          "",
          "```sh",
          "code-pact recommend --phase <p> --task <t> --agent claude-code --json",
          ...
          "# CI: add --audit-strict to refuse the flip when write_audit emits warnings.",
          "```",
          "",
        ...
        verifyBody: [
          ...
          "- In CI, prefer `task finalize --audit-strict --write --json` — the gate fires on any warning and refuses to flip the design YAML.",
          "",
          "At PR boundaries:",
          "",
        ...
        failBody: [
          ...
          "- **`VERIFICATION_FAILED`** (from `task complete`) — the phase's `verification.commands` failed. Fix the failing command and re-run; `task complete` is idempotent.",
