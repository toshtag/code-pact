    ...
    adapterCommon: {
      ...
      agentContract: {
        ...
        whenBody: [
          ...
          "# CI: --audit-strict を付けると write_audit に warning がある時 design YAML flip を拒否",
          "```",
          "",
        ...
        verifyBody: [
          ...
          "- CI では `task finalize --audit-strict --write --json` を推奨。warning があれば gate が発火し、design YAML を flip しません。",
          "",
          "PR 境界:",
          "",
        ...
        failBody: [
          ...
          "- **`VERIFICATION_FAILED`** (`task complete` から) — フェーズの `verification.commands` が失敗。失敗したコマンドを修正して再実行。`task complete` は idempotent です。",
