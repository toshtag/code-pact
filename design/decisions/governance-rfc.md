...
- **Progress.yaml write locking.** The append-only contract documented in docs/cli-contract.md (worst-case is event reordering, not corruption) makes lock-free safe. P14 does not change progress.yaml semantics.
