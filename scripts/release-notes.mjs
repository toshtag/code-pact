...
// (published-tarball shasum) is now auto-generated by `.github/workflows/publish.yml`
// after the registry tarball is verified — no longer added by hand.
...
function main(argv) {
  ...
  if (notes === null || notes === "") {
    process.stderr.write(
      `release-notes: no \"## [${version}]\" section in CHANGELOG.md\n`,
    );
    return 1;
  }
