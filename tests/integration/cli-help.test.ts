...
describe("cluster --help → usage, exit 0", () => {
  ...
  const RICH_LEAF_HELP: Array<[string[], RegExp, RegExp]> = [
    [
      ["task", "prepare", "--help"],
      /Usage: code-pact task prepare/,
      /--budget-bytes/,
    ],
    [
      ["task", "complete", "--help"],
      /Usage: code-pact task complete/,
      /--dry-run/,
    ],
    [
      ["task", "record-done", "--help"],
      /Usage: code-pact task record-done/,
      /--evidence/,
    ],
    [
      ["task", "finalize", "--help"],
      /Usage: code-pact task finalize/,
      /--audit-strict/,
    ],
    ...
    [["task", "cancel", "--help"], /Usage: code-pact task cancel/, /--write/],
    [
      ["plan", "prompt", "--help"],
      /Usage: code-pact plan prompt/,
      /--schema-only/,
    ],
    [
      ["phase", "import", "--help"],
      /Usage: code-pact phase import/,
      /--strict/,
    ],
    ...
    [
      ["plan", "constitution", "--help"],
      /Usage: code-pact plan constitution/,
      /--principle/,
    ],
    [["plan", "adopt", "--help"], /Usage: code-pact plan adopt/, /--write/],
    [
      ["plan", "lint", "--help"],
      /Usage: code-pact plan lint/,
      /--include-quality/,
    ],
    [
      ["plan", "normalize", "--help"],
      /Usage: code-pact plan normalize/,
      /--check/,
    ],
    [
      ["plan", "analyze", "--help"],
      /Usage: code-pact plan analyze/,
      /--include-historical/,
    ],
    [
      ["plan", "sync-paths", "--help"],
      /Usage: code-pact plan sync-paths/,
      /--rename/,
    ],
    ...
    [
      ["phase", "new", "--help"],
      /Usage: code-pact phase new/,
      /[Ii]nteractive/,
    ],
    [["phase", "ls", "--help"], /Usage: code-pact phase ls/, /--status/],
    [["phase", "show", "--help"], /Usage: code-pact phase show/, /--json/],
    [
      ["phase", "reconcile", "--help"],
      /Usage: code-pact phase reconcile/,
      /--write/,
    ],
    [
      ["phase", "archive", "--help"],
      /Usage: code-pact phase archive/,
      /--write/,
    ],
    [
      ["phase", "runbook", "--help"],
      /Usage: code-pact phase runbook/,
      /--across-phases/,
    ],
    [
      ["phase", "next", "--help"],
      /Usage: code-pact phase next/,
      /--across-phases/,
    ],
    [["adapter", "list", "--help"], /Usage: code-pact adapter list/, /--json/],
    [
      ["adapter", "install", "--help"],
      /Usage: code-pact adapter install/,
      /--force/,
    ],
    [
      ["adapter", "upgrade", "--help"],
      /Usage: code-pact adapter upgrade/,
      /--accept-modified/,
    ],
    [
      ["adapter", "doctor", "--help"],
      /Usage: code-pact adapter doctor/,
      /--agent/,
    ],
    [
      ["adapter", "conformance", "--help"],
      /Usage: code-pact adapter conformance/,
      /--json/,
    ],
    [
      ["decision", "prune", "--help"],
      /Usage: code-pact decision prune/,
      /--policy/,
    ],
    [
      ["decision", "retire", "--help"],
      /Usage: code-pact decision retire/,
      /--write/,
    ],
    [
      ["state", "compact", "--help"],
      /Usage: code-pact state compact/,
      /--write/,
    ],
    [
      ["state", "compact-archive", "--help"],
      /Usage: code-pact state compact-archive/,
      /decision_record/,
    ],
    [
      ["state", "archive-retention", "--help"],
      /Usage: code-pact state archive-retention/,
      /--keep-latest/,
    ],
    [
      ["state", "archive-maintain", "--help"],
      /Usage: code-pact state archive-maintain/,
      /--keep-latest/,
    ],
    [
      ["spec", "import", "--help"],
      /Usage: code-pact spec import/,
      /--suggest-from/,
    ],
    [
      ["context", "show", "--help"],
      /Usage: code-pact context show/,
      /--section/,
    ],
  ...
  it("`phase import --help` documents --scaffold-decisions and the skip (not overwrite) semantics of --force", () => {
    ...
    expect(res.stdout).toMatch(
      /--force\s[\s\S]*Skip phases whose ids already exist/,
    );
  ...
  it.each([
    ...
    "%s unknown subcommand guidance lists valid subcommands from the spec order",
    (cluster, subcommands) => {
